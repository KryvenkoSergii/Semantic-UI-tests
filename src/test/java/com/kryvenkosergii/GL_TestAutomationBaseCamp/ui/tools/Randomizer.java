...
/**
 * Randomizer class to get different sets of symbols, words, and numbers.
 * @author SergiiK
 */
public class Randomizer {
     ...
     * @return String
     */
    public static String getRamdomString1(int length, boolean useLetters, boolean useNumbers) {
    ...
    public static String getRamdomSpecSymbol() {
        ...
        String generatedString = random.ints(leftLimit, rightLimit + 1)
                .filter(i -> (i <= 47 || i >= 58) && (i <= 64 || i >= 91) && (i <= 96 || i >= 122)).limit(targetStringLength)
                .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append).toString();
        return generatedString;
    }

    /**
     * Returns a string that has ASCII symbols (!"#$%^&()*+,-./:;<=>?@[\]^_'{|}~) a
     * given length..
    ...
    public static String getRamdomStringLetters2(int targetStringLength) {
        ...
        String generatedString = random.ints(leftLimit, rightLimit + 1).filter(i -> (i <= 90 || i >= 97)).limit(targetStringLength)
                .collect(StringBuilder::new, StringBuilder::appendCodePoint, StringBuilder::append).toString();
        return generatedString;
    }
     ...
     * @return String
     */
    public static String getRamdomStringUppercaseLetters(int targetStringLength) {
        int leftLimit = 65; // ASCII symbol 'A'
     ...
     * @return String
     */
    public static String getRamdomStringLowercaseLetters(int targetStringLength) {
